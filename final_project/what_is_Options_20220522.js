...
let contract = {
  data: [],
  selection: "First Line", // + YOUR FILTER SELECTION
  part_month:"",
  part_strike:"",
  part_cp:"",
...
let contract1 = {
  data: [],
  selection: "Secen Line", // + YOUR FILTER SELECTION
  part_month:"",
  part_strike:"",
  part_cp:"",
...
function draw_legend(contract, contract1){
